...
<body>
    <main>
        <div class="container py-4">
            ...
            <div class="d-flex flex-row justify-content-between col-md-4 w-100">
                <?php
                $songs = $artist->getSongs();
                foreach ($songs as $song) {
                ?>
                    <div class="w-33 h-100 p-5 bg-body-tertiary border rounded-3 text-light" style="background-image: url(<?= $song->getCover(); ?>); background-size: contain;">
                        <audio>
