...
<body>
    <div id="carouselExampleCaptions" class="carousel slider" data-bs-ride="true"
        style="margin: 50px 320px 100px 320px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://d22ngpx8edtvxq.cloudfront.net/webuploads/_blockImage/93584/Foodhal-borrel-Enschede-2021-Liggend-LR-2-klein.webp"
            ...
            <div class="carousel-item">
                <img src="https://www.classicstogo.nl/files/2016/06/Top-10-Jazz-RH.jpg" class="d-block w-100"
                    alt="hello">
                <div class="carousel-caption d-none d-md-block bg-dark" style="--bs-bg-opacity: .5;">
                    <h3>Jazz</h3>
    ...
    <div class="container w-100">
        <div class="row container-custom justify-content-center">
            <div class='d-flex align-items column-gap-1'>
                ...
                <div class="col-sm-12 col-md-4">
                    <img src="https://www.classicstogo.nl/files/2016/06/Top-10-Jazz-RH.jpg"
                        alt="1">
