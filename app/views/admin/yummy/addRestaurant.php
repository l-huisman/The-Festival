    ...
    <div class="col-md-6">
      <form action="/yummy/addRestaurant" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="number" min="1" class="form-control" id="price" name="price" value="" required>
        </div>
        <div class="mb-3">
          <label for="number" class="form-label">Price kids</label>
          <input type="number" min="1" class="form-control" id="price" name="price_kids" value="" required>
        </div>
        <div class="mb-3">
